...
// Add or update these event handlers for the menu
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (menuToggle) {
        menuToggle.addEventListener('click', function(e) {
            ...
            if (sidebarMenuBg) {
                sidebarMenuBg.style.display = document.body.classList.contains('active') ? 'block' : 'none';
            }
        });
    }
    ...
    if (sidebarMenuBg) {
        sidebarMenuBg.addEventListener('click', function() {
    ...
    const dropdowns = document.querySelectorAll('.header_menu .nav-item.dropdown');
    ...
    document.addEventListener('click', function(e) {
        if (!e.target.closest('.header_menu')) {
            document.querySelectorAll('.header_menu .dropdown-menu.show').forEach(menu => {
