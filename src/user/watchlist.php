      ...
      <div class="profile-content">
        <div class="container">
          <div class="profile-box profile-box-watchlist makeup">
            ...
            <section class="block_area block_area_category lazy-component mt-4" data-component="category">
                        <div class="block_area-header">

                            <div class="float-left bah-heading mr-4">
                                <h2 class="cat-heading">Wann add more anime?</h2>
                            </div>
                            <div class="float-right viewmore">
                                <a class="btn" href="/anime/top-airing">View more<i
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature ">
                                <div class="film_list-wrap">
                                    ...
                                    <?php
                                    // Fetch JSON data
                                    $json = file_get_contents("$zpi/top-airing");
