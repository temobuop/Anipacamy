        ...
        return s || (s = function(t) {
            ...
            if (e && s && f)
                return p = n.e(6).then(function(t) {
                    n(37);
                    var e = n(20).default;
                    return a.a.controls = n(19).default,
...
, function(t, e, n) {
    ...
    var r = n(30)
      ...
      , u = function() {
        var t = "//ssl.p.jwpcdn.com/player/v/8.8.6/"
...
, function(t, e, n) {
    ...
    var r = "8.8.6+commercial_v8-8-6.320.commercial.c34bbcb.hlsjs..jwplayer.8c03955.dai.45542e3.freewheel.9422044.googima.dc5517d.vast.1e860ad.analytics.aea2191.gapro.141397a"
}
, function(t, e, n) {
    "use strict";
    var r = n(0)
...
, function(t, e, n) {
    ...
    function j(t) {
        var e = "file:" === window.location.protocol ? "https:" : ""
          , n = {
            jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.8.6/jwpsrv.js",
            dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.9/dai.js",
            vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.5.15/vast.js",
            googima: "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.5.20/googima.js",
    ...
    var O = function(t, e) {
        ...
        u.plugins = function(t) {
            ...
            var s = t.related
              ...
              , f = !1 !== t.visualplaylist || !l;
            return t.related = Object(r.j)({}, s, {
                disableRelated: l,
                showButton: f
            }),
            e
    ...
    function D(t, e) {
        ...
        return z(t) || r.push(function(t, e) {
            var r = t.get("related");
            if (!1 !== t.get("controls") || !r.disableRelated)
                return n.e(16).then(function(i) {
                    if (!t.attributes._destroyed) {
                        var o = new M.a;
                        o.name = "related",
                        o.js = n(146).default,
                ...
                .bind(null, n)).catch(Object(k.b)(R)).catch(function(t) {
                    return t
                });
    ...
    var Q = function(t) {
        ...
        this.start = function(n) {
            var r = Object(C.a)(t, n)
              , i = Promise.all([Object(k.d)(t), r, L(t), D(t, n), q(t), V(t)])
...
, function(t, e, n) {
    ...
    Z.api = j,
    Z._ = r.f,
    Z.version = "8.8.6+commercial_v8-8-6.320.commercial.c34bbcb.hlsjs..jwplayer.8c03955.dai.45542e3.freewheel.9422044.googima.dc5517d.vast.1e860ad.analytics.aea2191.gapro.141397a",
